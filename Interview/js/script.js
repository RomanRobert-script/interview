...
var cal = {
  ...
  show : function (el) {
    ...
    tForm += "<div id='evt-date'>" + cal.sDay + " " + cal.mName[cal.sMth] + " " + cal.sYear + "   "+ datetime + "</div>";    
  ...
  save : function (evt) {
    ...
    // cal.mName[cal.sMth] = document.getElementById("evt-date").value;
    //  console.log(cal.mName[cal.sMth]);

    cal.data[cal.sDay] = document.getElementById("evt-details").value;
    localStorage.setItem("cal-" + cal.sMth + "-" + cal.sYear, JSON.stringify(cal.data));
    
    var str = document.getElementById("evt-date").value;

    var str,
element = document.getElementById("evt-date");
if (element != null) {
    str = element.value;
}
else {
...
window.addEventListener("load", function () {
  ...
  for (var i = nowYear-0; i<=nowYear+0; i++) {
    var opt = document.createElement("option");
    opt.value = i;
    opt.innerHTML = i;
